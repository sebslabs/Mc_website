...
export const Footer: React.FC = () => {
  return (
    <footer className="bg-brand-navy border-t-2 border-brand-red text-white w-full">
      <div className="w-full px-4 sm:px-6 lg:px-8 grid grid-cols-1 md:grid-cols-4 md:divide-x divide-y md:divide-y-0 divide-brand-red border-b border-brand-red">
        {/* Brand Column */}
        <div className="flex flex-col items-center md:items-start text-center md:text-left gap-4 py-12 md:py-16 md:pr-8">
        ...
        {/* Explore Links */}
        <div className="py-8 md:py-16 md:px-8 text-center md:text-left flex flex-col items-center md:items-start">
          <h4 className="font-display font-bold text-white tracking-wider uppercase text-sm mb-6">
            Explore
          </h4>
          <ul className="flex flex-col items-center md:items-start gap-3 text-sm text-white/70">
        ...
        {/* Contact Info Column */}
        <div className="py-8 md:py-16 md:pl-8 text-center md:text-left flex flex-col items-center md:items-start">
          <h4 className="font-display font-bold text-white tracking-wider uppercase text-sm mb-6">
            Get In Touch
          </h4>
          <ul className="flex flex-col items-center md:items-start gap-6 md:gap-4 text-sm text-white/70">
            <li className="flex flex-col md:flex-row items-center md:items-start gap-2 md:gap-3">
              <MapPin className="w-5 h-5 text-brand-red flex-shrink-0 md:mt-0.5" />
            ...
            <li className="flex flex-col md:flex-row items-center md:items-start gap-2 md:gap-3">
              <Clock className="w-5 h-5 text-brand-red flex-shrink-0 md:mt-0.5" />
      ...
      <div className="w-full px-4 sm:px-6 lg:px-8 py-8 flex flex-col md:flex-row justify-between items-center gap-4 text-xs text-white/40 text-center md:text-left">
